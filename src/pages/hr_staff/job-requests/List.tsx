...
export default function HRJobRequestList() {
    ...
    const [applicationsTabFilter, setApplicationsTabFilter] = useState<"all" | "my-responsible">("all");
                            ...
                            <div className="p-5">
                                ...
                                <div className="mb-4">
                                    <div className="flex gap-2 border-b border-gray-200">
                                        ...
                                        <button
                                            onClick={() => setApplicationsTabFilter("my-responsible")}
                                            className={`px-6 py-3 font-medium text-sm transition-all duration-300 border-b-2 ${
                                                applicationsTabFilter === "my-responsible"
                                                    ? "border-purple-600 text-purple-600 bg-purple-50"
                                                    : "border-transparent text-gray-600 hover:text-purple-600 hover:bg-purple-50"
                                            }`}
                                        >
                                            Hồ sơ của tôi phụ trách ({applications.filter(app => app.recruiterId === user?.id).length})
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <div className="space-y-3">
                                            {applications
                                                .filter(app => {
                                                    ...
                                                    if (applicationsTabFilter === "my-responsible") {
                                                        return app.recruiterId === user?.id;
                                                    }
                                                    return true;
                                                })
                                                .sort((a, b) => {
